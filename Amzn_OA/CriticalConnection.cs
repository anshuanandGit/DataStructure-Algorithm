...
namespace Amzn_OA
{
    class CriticalConnection
    {
        public static void Start()
        {
            ...
            List<List<int>> op = CriticalConnections(numRouters, links);
        ...
        public static List<List<int>> CriticalConnections(int n, int[][] connections)
        {
            int[] disc = new int[n];
            int[] low = new int[n];
        ...
        private static void DFS(int u, int[] low, int[] disc, List<int>[] graph, List<List<int>> res, int pre)
        {
